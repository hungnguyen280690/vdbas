...
import com.fis.vdbas.exp.application.dossier.service.OpexDocumentService;
...
/** Chứng từ trong hồ sơ OPEX — {@code /api/v1/exp/opex/dossiers/{dossierId}/documents}. */
@RestController
@RequestMapping("/api/v1/exp/opex/dossiers/{dossierId}/documents")
@RequiredArgsConstructor
public class OpexDocumentController {

    private final OpexDocumentService service;
    ...
    public DocumentDetailDto add(@PathVariable UUID dossierId, @Valid @RequestBody OpexAddDocumentRequest body) {
    ...
    public DocumentDetailDto update(@PathVariable UUID dossierId, @PathVariable UUID documentId,
            @Valid @RequestBody OpexAddDocumentRequest body) {
