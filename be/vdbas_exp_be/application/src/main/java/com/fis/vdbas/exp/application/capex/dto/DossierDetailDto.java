...
public class DossierDetailDto {
    ...
    private List<DocumentDetailDto> documents = new ArrayList<>();
    private List<AttachmentInfoDto> attachments = new ArrayList<>();
    private List<ApprovalLogEntryDto> approvalHistory = new ArrayList<>();
}
