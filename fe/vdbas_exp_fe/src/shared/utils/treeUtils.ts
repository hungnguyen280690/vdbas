 ...
 */
export const listToTree = (list: any[], idKey: string = 'id', parentKey: string = 'parentId'): any[] => {
 ...
 */
export const buildCategoryTree = (items: any[], parentId: any = null): any[] => {
 ...
 */
export const filterTree = (tree: any[], predicate: (node: any) => boolean): any[] => {
  return tree
    .map((node) => ({ ...node }))
    .filter(function filter(node: any) {
 ...
 */
export const findPathInTree = (tree: any[], targetPath: string): any[] => {
